...
categories <- as.data.frame(html_table(all.tables[4], fill = TRUE))  # Example 

#based on the example we called all the relevant tables in order and names them accordingly 
list_by_region <- as.data.frame(html_table(all.tables[5], fill = TRUE))
list_by_region22 <- as.data.frame(html_table(all.tables[6], fill = TRUE))
list_by_country <- as.data.frame(html_table(all.tables[7], fill = TRUE))
components <- as.data.frame(html_table(all.tables[8], fill = TRUE))
...
all.tables = html_nodes(gdp_url, "table")  
gdp_table <- as.data.frame(html_table(all.tables[2], fill = TRUE))  


all.tables = html_nodes(population_size_url, "table")  
population_size_table <- as.data.frame(html_table(all.tables[2], fill = TRUE))  

all.tables = html_nodes(incarnation_rates_url, "table")  
incarnation_rate_table <- as.data.frame(html_table(all.tables[2], fill = TRUE))


all.tables = html_nodes(area_url, "table")  
area_table <- as.data.frame(html_table(all.tables[2], fill = TRUE))  
