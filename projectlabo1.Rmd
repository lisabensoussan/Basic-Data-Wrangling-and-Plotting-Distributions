...
In this graph we can see that there is a better scatter of the gdp for a randonly selected person by land area :
majority of the population (0.6) have a 30,000 gdp and under, and the (0.4) is located between 30k and 65k.
...
In 2006 Africa was mostly low democratic with some exceptions, and Russia was orange - on the middle of the scale.
America and Europe and Australia are very democratic.

In 2022 Africa was has become more democratic (more orange countries) with some exceptions, and Russia has become yellow - less democratic than it was.
America and Europe and Australia stayed almost the same.
...
We can say that the following pairs have highest correlations : (EPP ,FG),(EPP ,Political Participation(PP)), (PP, CL).
