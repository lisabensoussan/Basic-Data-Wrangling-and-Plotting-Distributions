...
plot(joined_table$X2022, joined_table$CIA.est, xlab = "Democracy Index", ylab = "GDP (PPP) per capita")
...
plot(joined_table$X2022, joined_table$Rate.100000, xlab = "Democracy Index", ylab = "Incarnation Rate")
